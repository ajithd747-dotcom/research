...
| OGR-047 | Venue selection: execution on Binance + Hyperliquid, reference-only Kraken/OKX/Coinbase, Bybit deferred | operations | PLANNED | P0 | ARCHITECTURE.md §3b | "deliberately unalike so they fail differently, at the cost of duplicating nearly everything in the ops layer" |
