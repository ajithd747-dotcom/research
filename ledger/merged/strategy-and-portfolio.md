...
| # | Requirement | Category | Status | Phase | Evidence / satisfying module | Sources | Notes |
|---|---|---|---|---|---|---|---|
| SP-056 | Funding-rate carry | strategy | PLANNED | P1 | `FEATURES.md` §4; `ARCHITECTURE.md` §Build order Phase 4 — "start here" | research-corpus, crypto-bot-and-nse-botonly | Latency-immune, viable at this size |
